$(document).ready(function(){
    ...
    function username_validation() {
        ...
        if (username_val.length < 4) {
            $('#usernamevalidation').show();
            $('#usernamevalidation').html('Username should contain at least 4 characters');
            $('#usernamevalidation').css('color', 'red');
            username_error = false;
            return false; 
        } else {
    ...
    function confirm_password_validation(){
        ...
        if (password_val != confirm_password_val) {
            ...
            $('#confirmpasswordvalidation').html('Make Sure password match');
    ...
    $('#submitvalidation').click(function(){
        ...
        password_validation();
        confirm_password_validation();
        if (username_error == true && password_error == true && confirm_password_error == true) {
            return true;
        } else {
            return false;
        }
